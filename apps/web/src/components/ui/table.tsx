...
>(({ classNames, ...props }, ref) => {
    return (
        <div ref={ref} data-slot="table-container" className={cn("relative h-full w-full", classNames?.container)}>
            <table data-slot="table" className={cn("w-full caption-bottom text-sm", classNames?.table)} {...props} />
        </div>
    );
});
