 ...
 */
function transformGitHubCopilotModels(htmlContent: string): Model[] {
      ...
      if (row.length >= headers.length) {
        ...
        if (modelInfo.model_name) {
          const model: Model = {
            ...
            temperature: true,
            knowledge: null,
            toolCall: false, // GitHub Copilot doesn't support tool calls
            openWeights: false,
            cost: {
            ...
            cacheRead: false, // GitHub Copilot doesn't support context caching
          };
