...
const modelSchema = z.strictObject({
    ...
    cost: z.strictObject({
        ...
        imageGeneration: z.number().nullish(),
        imageGenerationUltra: z.number().nullish(),
        input: z.number().nullable(),
        inputCacheHit: z.number().nullable(),
        output: z.number().nullable(),
        // Video generation pricing
        videoGeneration: z.number().nullish(),
        videoGenerationWithAudio: z.number().nullish(),
        videoGenerationWithoutAudio: z.number().nullish(),
    }),
    ...
    streamingSupported: z.boolean().nullish(),
    ...
    thumbnail: z.string().trim().nullish(), // Thumbnail image/video URL or local path

    toolCall: z.boolean(),
    trainingCutoff: z.string().trim().nullish(),
    version: z.string().trim().nullish(),
    // Version management
    versions: z.strictObject({
        preview: z.string().trim().nullish(),
        stable: z.string().trim().nullish(),
    })
