...
import providerData from "../../public/cloudflare.json";
...
/**
 * Retrieves all AI models for Cloudflare.
 * @returns Array of models belonging to Cloudflare.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Cloudflare.
...
/**
 * Searches and filters AI models for Cloudflare based on various criteria.
...
/**
 * Gets the total number of models for Cloudflare.
