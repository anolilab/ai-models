...
import providerData from "../../public/chutes.json";
...
/**
 * Retrieves all AI models for chutes.
 * @returns Array of models belonging to chutes.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for chutes.
...
/**
 * Searches and filters AI models for chutes based on various criteria.
...
/**
 * Gets the total number of models for chutes.
