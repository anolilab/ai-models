...
import providerData from "../../public/ai-hub-mix.json";
...
/**
 * Retrieves all AI models for AIHubMix.
 * @returns Array of models belonging to AIHubMix.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for AIHubMix.
...
/**
 * Searches and filters AI models for AIHubMix based on various criteria.
...
/**
 * Gets the total number of models for AIHubMix.
