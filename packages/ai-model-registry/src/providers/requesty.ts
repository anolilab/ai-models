...
import providerData from "../../public/requesty.json";
...
/**
 * Retrieves all AI models for Requesty.
 * @returns Array of models belonging to Requesty.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Requesty.
...
/**
 * Searches and filters AI models for Requesty based on various criteria.
...
/**
 * Gets the total number of models for Requesty.
