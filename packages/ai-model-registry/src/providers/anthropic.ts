...
import providerData from "../../public/anthropic.json";
...
/**
 * Retrieves all AI models for Anthropic.
 * @returns Array of models belonging to Anthropic.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Anthropic.
...
/**
 * Searches and filters AI models for Anthropic based on various criteria.
...
/**
 * Gets the total number of models for Anthropic.
