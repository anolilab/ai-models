...
import providerData from "../../public/amazon-bedrock.json";
...
/**
 * Retrieves all AI models for Amazon Bedrock.
 * @returns Array of models belonging to Amazon Bedrock.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Amazon Bedrock.
...
/**
 * Searches and filters AI models for Amazon Bedrock based on various criteria.
...
/**
 * Gets the total number of models for Amazon Bedrock.
