...
import providerData from "../../public/git-hub-copilot.json";
...
/**
 * Retrieves all AI models for GitHub Copilot.
 * @returns Array of models belonging to GitHub Copilot.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for GitHub Copilot.
...
/**
 * Searches and filters AI models for GitHub Copilot based on various criteria.
...
/**
 * Gets the total number of models for GitHub Copilot.
