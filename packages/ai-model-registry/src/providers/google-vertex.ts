...
import providerData from "../../public/google-vertex.json";
...
/**
 * Retrieves all AI models for Google Vertex.
 * @returns Array of models belonging to Google Vertex.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Google Vertex.
...
/**
 * Searches and filters AI models for Google Vertex based on various criteria.
...
/**
 * Gets the total number of models for Google Vertex.
