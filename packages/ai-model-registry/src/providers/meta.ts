...
import providerData from "../../public/meta.json";
...
/**
 * Retrieves all AI models for Meta.
 * @returns Array of models belonging to Meta.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Meta.
...
/**
 * Searches and filters AI models for Meta based on various criteria.
