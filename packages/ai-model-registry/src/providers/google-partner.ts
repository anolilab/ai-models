...
import providerData from "../../public/google-partner.json";
...
/**
 * Retrieves all AI models for Google Partner.
 * @returns Array of models belonging to Google Partner.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Google Partner.
...
/**
 * Searches and filters AI models for Google Partner based on various criteria.
...
/**
 * Gets the total number of models for Google Partner.
