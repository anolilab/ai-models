...
import providerData from "../../public/weights-&-biases.json";
...
/**
 * Retrieves all AI models for Weights & Biases.
 * @returns Array of models belonging to Weights & Biases.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Weights & Biases.
...
/**
 * Searches and filters AI models for Weights & Biases based on various criteria.
...
/**
 * Gets the total number of models for Weights & Biases.
