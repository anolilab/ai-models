...
import providerData from "../../public/git-hub-models.json";
...
/**
 * Retrieves all AI models for GitHub Models.
 * @returns Array of models belonging to GitHub Models.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for GitHub Models.
...
/**
 * Searches and filters AI models for GitHub Models based on various criteria.
...
/**
 * Gets the total number of models for GitHub Models.
