...
import providerData from "../../public/open-router.json";
...
/**
 * Retrieves all AI models for OpenRouter.
 * @returns Array of models belonging to OpenRouter.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for OpenRouter.
...
/**
 * Searches and filters AI models for OpenRouter based on various criteria.
...
/**
 * Gets the total number of models for OpenRouter.
