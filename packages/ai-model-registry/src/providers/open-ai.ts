...
import providerData from "../../public/open-ai.json";
...
/**
 * Retrieves all AI models for OpenAI.
 * @returns Array of models belonging to OpenAI.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for OpenAI.
...
/**
 * Searches and filters AI models for OpenAI based on various criteria.
...
/**
 * Gets the total number of models for OpenAI.
