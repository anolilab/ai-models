...
import providerData from "../../public/google.json";
...
/**
 * Retrieves all AI models for Google.
 * @returns Array of models belonging to Google.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Google.
...
/**
 * Searches and filters AI models for Google based on various criteria.
...
/**
 * Gets the total number of models for Google.
