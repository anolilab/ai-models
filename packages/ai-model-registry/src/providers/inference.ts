...
import providerData from "../../public/inference.json";
...
/**
 * Retrieves all AI models for Inference.
 * @returns Array of models belonging to Inference.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Inference.
...
/**
 * Searches and filters AI models for Inference based on various criteria.
...
/**
 * Gets the total number of models for Inference.
