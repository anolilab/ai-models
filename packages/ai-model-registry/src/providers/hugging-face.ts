...
import providerData from "../../public/hugging-face.json";
...
/**
 * Retrieves all AI models for Hugging Face.
 * @returns Array of models belonging to Hugging Face.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Hugging Face.
...
/**
 * Searches and filters AI models for Hugging Face based on various criteria.
...
/**
 * Gets the total number of models for Hugging Face.
