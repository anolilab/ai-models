...
import providerData from "../../public/azure-open-ai.json";
...
/**
 * Retrieves all AI models for Azure OpenAI.
 * @returns Array of models belonging to Azure OpenAI.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Azure OpenAI.
...
/**
 * Searches and filters AI models for Azure OpenAI based on various criteria.
...
/**
 * Gets the total number of models for Azure OpenAI.
