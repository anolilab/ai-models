...
import providerData from "../../public/venice.json";
...
/**
 * Retrieves all AI models for Venice.
 * @returns Array of models belonging to Venice.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Venice.
...
/**
 * Searches and filters AI models for Venice based on various criteria.
...
/**
 * Gets the total number of models for Venice.
