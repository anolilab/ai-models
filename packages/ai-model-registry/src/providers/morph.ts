...
import providerData from "../../public/morph.json";
...
/**
 * Retrieves all AI models for Morph.
 * @returns Array of models belonging to Morph.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Morph.
...
/**
 * Searches and filters AI models for Morph based on various criteria.
...
/**
 * Gets the total number of models for Morph.
