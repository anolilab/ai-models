...
import providerData from "../../public/groq.json";
...
/**
 * Retrieves all AI models for Groq.
 * @returns Array of models belonging to Groq.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Groq.
...
/**
 * Searches and filters AI models for Groq based on various criteria.
...
/**
 * Gets the total number of models for Groq.
