...
import providerData from "../../public/deep-infra.json";
...
/**
 * Retrieves all AI models for Deep Infra.
 * @returns Array of models belonging to Deep Infra.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Deep Infra.
...
/**
 * Searches and filters AI models for Deep Infra based on various criteria.
...
/**
 * Gets the total number of models for Deep Infra.
