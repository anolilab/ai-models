...
import providerData from "../../public/mistral.json";
...
/**
 * Retrieves all AI models for Mistral.
 * @returns Array of models belonging to Mistral.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Mistral.
...
/**
 * Searches and filters AI models for Mistral based on various criteria.
...
/**
 * Gets the total number of models for Mistral.
