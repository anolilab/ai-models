...
import providerData from "../../public/upstage.json";
...
/**
 * Retrieves all AI models for Upstage.
 * @returns Array of models belonging to Upstage.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Upstage.
...
/**
 * Searches and filters AI models for Upstage based on various criteria.
...
/**
 * Gets the total number of models for Upstage.
