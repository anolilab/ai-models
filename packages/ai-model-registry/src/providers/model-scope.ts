...
import providerData from "../../public/model-scope.json";
...
/**
 * Retrieves all AI models for ModelScope.
 * @returns Array of models belonging to ModelScope.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for ModelScope.
...
/**
 * Searches and filters AI models for ModelScope based on various criteria.
...
/**
 * Gets the total number of models for ModelScope.
