...
import providerData from "../../public/cerebras.json";
...
/**
 * Retrieves all AI models for cerebras.
 * @returns Array of models belonging to cerebras.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for cerebras.
...
/**
 * Searches and filters AI models for cerebras based on various criteria.
...
/**
 * Gets the total number of models for cerebras.
