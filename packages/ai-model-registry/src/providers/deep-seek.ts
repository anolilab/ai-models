...
import providerData from "../../public/deep-seek.json";
...
/**
 * Retrieves all AI models for DeepSeek.
 * @returns Array of models belonging to DeepSeek.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for DeepSeek.
...
/**
 * Searches and filters AI models for DeepSeek based on various criteria.
...
/**
 * Gets the total number of models for DeepSeek.
