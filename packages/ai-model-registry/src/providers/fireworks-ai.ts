...
import providerData from "../../public/fireworks-ai.json";
...
/**
 * Retrieves all AI models for Fireworks AI.
 * @returns Array of models belonging to Fireworks AI.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Fireworks AI.
...
/**
 * Searches and filters AI models for Fireworks AI based on various criteria.
...
/**
 * Gets the total number of models for Fireworks AI.
