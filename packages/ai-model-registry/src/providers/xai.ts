...
import providerData from "../../public/xai.json";
...
/**
 * Retrieves all AI models for XAI.
 * @returns Array of models belonging to XAI.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for XAI.
...
/**
 * Searches and filters AI models for XAI based on various criteria.
...
/**
 * Gets the total number of models for XAI.
