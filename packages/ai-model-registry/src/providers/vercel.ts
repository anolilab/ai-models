...
import providerData from "../../public/vercel.json";
...
/**
 * Retrieves all AI models for Vercel.
 * @returns Array of models belonging to Vercel.
 */
export const getModels = (): Model[] => [...models];

/**
 * Retrieves a specific AI model by its unique identifier for Vercel.
...
/**
 * Searches and filters AI models for Vercel based on various criteria.
...
/**
 * Gets the total number of models for Vercel.
