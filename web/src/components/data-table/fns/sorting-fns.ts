...
const fuzzy = <TData extends MRT_RowData>(rowA: Row<TData>, rowB: Row<TData>, columnId: string) => {
    let dir = 0;
...
export const rankGlobalFuzzy = <TData extends MRT_RowData>(rowA: MRT_Row<TData>, rowB: MRT_Row<TData>) =>
